...
insert_options('social_buff_maintenance', 0);
insert_options('social_buff_api_url', '');
insert_options('social_buff_api_key', '');
insert_options('social_buff_markup_percent', '');
insert_options('social_buff_timeout', '');
