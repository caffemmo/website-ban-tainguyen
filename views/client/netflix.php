...
>
    <section class="netflix-hero" aria-labelledby="netflix-page-title">
        <div>
            ...
            <p><?= __('Tạo link đăng nhập Netflix riêng cho bạn từ hệ thống Caffemmo.'); ?></p>
        </div>
    ...
    <div class="netflix-content-grid">
        <section class="netflix-panel" aria-labelledby="netflix-service-title">
            ...
            <a class="netflix-history-link" href="<?= htmlspecialchars(base_url('client/netflix-history'), ENT_QUOTES, 'UTF-8'); ?>"><i class="fa-solid fa-clock-rotate-left" aria-hidden="true"></i> <?= __('Xem lịch sử và tạo lại link'); ?></a>
            ...
            <div class="netflix-result" data-netflix-result hidden aria-live="polite">
                ...
                <div class="netflix-result-actions">
                    ...
                    <button class="netflix-refresh-button" data-netflix-refresh type="button" hidden><i class="fa-solid fa-rotate" aria-hidden="true"></i> <?= __('Tạo lại link'); ?></button>
                </div>
            </div>
        </section>
        ...
        <aside class="netflix-panel netflix-side-panel" aria-labelledby="netflix-guide-title">
            ...
            <ul class="netflix-check-list">
                ...
                <li><i class="fa-solid fa-circle-check" aria-hidden="true"></i><span><?= __('Nếu link hết hạn, tạo một link mới.'); ?></span></li>
            </ul>
        </aside>
    </div>
</main>
