...
$tab_config = [
    ...
    'locket-gold'          => ['file' => 'locket-gold.php',          'icon' => 'fa-solid fa-crown',                                'label' => __('Locket Gold Vĩnh Viễn')],
    'social-buff'          => ['file' => 'social-buff.php',          'icon' => 'fa-solid fa-bolt',                                 'label' => __('Buff mạng xã hội')],
